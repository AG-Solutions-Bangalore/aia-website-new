...
//                   SBI Card is one of India's leading credit card issuers,
//                   operating in a highly regulated and fraud-sensitive
//                   environment. AIA supported SBI Card through focused Certified
//                   Fraud Examiner (CFE) training, aimed at strengthening fraud
//                   awareness, detection techniques, and investigative thinking
//                   among professionals. The program helped teams better identify
//                   fraud risks, enhance compliance alignment, and apply
//                   structured fraud prevention practices across critical
//                   operational areas.
//                 </p>
//               </div>
//             </div>
...
//                 Adani Group is a diversified conglomerate with operations
//                 spanning infrastructure, energy, and logistics. AIA conducted
//                 CFE-based professional training to build awareness around fraud
//                 risks, ethical practices, and governance responsibilities. The
//                 program supported professionals in understanding complex fraud
//                 scenarios, reinforcing internal controls, and promoting a
//                 proactive approach to risk management, contributing to stronger
//                 governance and compliance culture across business functions.
//               </p>
//             </div>
...
//                 </h3>
//                 <p className="text-white text-lg">
//                   Bajaj Allianz is a trusted name in insurance and financial
//                   services, where fraud risk management plays a critical role.
//                   We delivered CFE-oriented training to equip professionals with
//                   practical knowledge in fraud detection, investigation
//                   methodologies, and control mechanisms. This training enabled
//                   teams to improve internal vigilance, strengthen fraud response
//                   frameworks, and support more informed decision-making in risk
//                   and compliance functions across the organization.
//                 </p>
//               </div>
//             </div>
//           </div>
