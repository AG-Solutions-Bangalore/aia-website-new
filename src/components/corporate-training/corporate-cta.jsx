          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex-1 text-center md:text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/10 mb-4">
                ...
                <span className="text-white text-xs font-semibold uppercase tracking-wider">CUSTOM TRAINING</span>
              </div>
              
              <h2 className="text-2xl md:text-3xl font-bold text-white leading-tight">
                Let's Design Your Custom<br className="hidden md:block" /> Training Plan Today!
              </h2>
            </div>
            ...
            <div className="p-6">
              <div className="mb-6">
                ...
                <p className="text-gray-600 text-sm mt-1">
                  Fill in your details and our training experts will design a custom plan for your team
                </p>
              </div>
