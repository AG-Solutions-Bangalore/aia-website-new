...
export default function AvatarPicker() {
    ...
    return (
        <motion.div initial="hidden" animate="visible" className="w-full">
            <Card
                className="w-full max-w-md mx-auto overflow-hidden bg-gradient-to-b from-background to-muted/30">
                <CardContent className="p-0">
                    ...
                    <div className="px-8 pb-8 -mt-16">
                        ...
                        {/* Avatar selection */}
                        <motion.div className="mt-6" variants={pickerVariants}>
                            <motion.div className="flex justify-center gap-4" variants={pickerVariants}>
                                {avatars.map((avatar) => (
                                    <motion.button
                                        key={avatar.id}
                                        onClick={() =>
