...
const CiaCurrHighlight = () => {
  return (
    ...
    description="Our programs are recognized by international accreditation and professional
bodies, reinforcing our commitment to quality education and global
relevance."
    stats={[
      {
        value: "50,000+ Hours",
