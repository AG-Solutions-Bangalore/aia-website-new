...
//     queryFn: async () => {
//       const res = await axios.get(`${BASE_URL}/api/getCertificatebyCourse/cia`);
//       return res.data;
//     },
//   });
//   console.log(certificatesData, "certificatesDataggg");
...
//     const certificateNoImageUrl = certificatesData.image_url?.find(
//       (item) => item.image_for === "No Image",
//     );
//     return certificatesData.data.map((certificate) => ({
//       author: {
//         avatar: `${certificate.student_other_certificate_image ? certificateImageUrl + certificate.student_other_certificate_image : certificateNoImageUrl?.image_url || ""}`,
//       },
