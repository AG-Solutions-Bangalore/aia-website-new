...
const CamsReview = () => {
  ...
  const { data: testimonialsData, isLoading, isError } = useQuery({
...
const ScrollableTestimonials = ({ testimonials, imageUrl, containerRef }) => {
  ...
  return (
    <div ref={containerRef} className="relative " style={{ height: `${testimonials.length * 100}vh` }}>
