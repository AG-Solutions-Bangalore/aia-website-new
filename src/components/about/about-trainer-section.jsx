        ...
        <div className="grid lg:grid-cols-2 gap-0 items-center">
          ...
          <div className="text-white py-2">
            ...
            <div className="space-y-2 text-base leading-relaxed">
              ...
              <p  className="font-bold italic">He has also served as anAuthorized Trainer with the NSE Academy, contributing to the professional development of finance and audit professionals across India. 
